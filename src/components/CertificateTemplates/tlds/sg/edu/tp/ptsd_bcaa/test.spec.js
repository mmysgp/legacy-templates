...
const BcaaLogo = Selector('img[title="BCA Academy"]');
...
test("Part-time Joint Specialist Diploma with BCAA is rendered correctly.", async t => {
  ...
  await t.expect(BcaaLogo.exists).ok();
