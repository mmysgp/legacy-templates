...
const SpfLogo = Selector('img[title="Singapore Police Force"]');
const CertisLogo = Selector('img[title="Certis"]');
const SatsLogo = Selector('img[title="Auxiliary Police Force"]');
...
test("Part-time Joint Diploma with Singapore Police Force is rendered correctly.", async t => {
