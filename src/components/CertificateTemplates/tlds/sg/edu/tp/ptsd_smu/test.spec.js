...
const SmuLogo = Selector('img[title="Singapore Management University"]');
...
test("Part-time Joint Specialist Diploma with SMU is rendered correctly.", async t => {
  ...
  await t.expect(SmuLogo.exists).ok();
