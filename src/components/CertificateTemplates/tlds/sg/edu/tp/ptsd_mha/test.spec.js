...
const MhaLogo = Selector('img[title="Ministry of Home Affairs"]');
...
test("Part-time Joint Specialist Diploma with MHA is rendered correctly.", async t => {
  ...
  await t.expect(MhaLogo.exists).ok();
