...
const Certificate = "./XXXXXXX_BJ004_UOG.opencert";
...
test("2019-situogcert certificate is rendered correctly", async t => {
  ...
  await validateTextContent(t, RenderedCertificate, [
    "UOG STUDENT NAME",
    "the Senate of the University of Glasgow was conferred the joint degree of",
    "BACHELOR OF SCIENCE",
    "in Nursing",
    "on 11th July 2018."
  ]);
