...
const Certificate = "./XXXXXXX_BJ009_NU.opencert";
...
test("2019-sitnucert certificate is rendered correctly", async t => {
  ...
  await validateTextContent(t, RenderedCertificate, [
    "NU STUDENT NAME",
    "University of Newcastle upon Tyne was conferred the joint degree of",
