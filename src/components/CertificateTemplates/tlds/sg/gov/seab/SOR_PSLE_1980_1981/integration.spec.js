...
fixture("Singapore Examinations and Assessment Board (SOR_PSLE_1980_1981)")
  .page`http://localhost:3000`;

const Certificate = "./SOR_ALL-1981_PSLE_01313F.opencert";
...
test("sg/gov/seab/SOR_PSLE_1980_1981 is rendered correctly", async t => {
